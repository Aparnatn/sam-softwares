...
export class UserService {
  ...
  ledger(data: LedgerRequest): Observable<LedgerResponse> {
    return this.http.post<LedgerResponse>(`${this.apiUrl}/Sam/ledg`, data, {
      // observe: 'response',
      // withCredentials: true
    });
  }
  ...
  getemp(id:number): Observable<EmployeeResponse> {
    return this.http.get<EmployeeResponse>(`${this.apiUrl}/Sam/employee/${id}/update`,
    );
  }
